  ...
  function AddDays(){
    ...
    for(var i = 0; i < calendar.Selected.Days; i++){
      ...
      for(var n = 0; n < calendar.Model.length; n++){
        // compare to the previus date if any to show only the first occurrency of event on the same date!
        var prEvDate = typeof(calendar.Model[n-1]) !== "undefined" ? calendar.Model[n-1].Date.getTime() : 0;
        var evDate = calendar.Model[n].Date;
        var toDate = new Date(calendar.Selected.Year, calendar.Selected.Month, (i+1));
        if(evDate.getTime() == toDate.getTime() && evDate.getTime() !== prEvDate){
          ...
          var argang = document.createElement('span');
          title.className += "cld-title";
          tema.className += "cld-title";
          color.className += "cld-title";
          ps.className += "cld-title";
          gt.className += "cld-title";
          ep.className += "cld-title";
          ev.className += "cld-title";
          argang.className += "cld-title";
          ...
          number.appendChild(ps);
          number.appendChild(gt);
          number.appendChild(ep);
          number.appendChild(ev);
          number.appendChild(argang);
        }
      }
      day.appendChild(number);
      // If Today..
