...
var replaceBooks = [
  ...
  ["1 Tim", "1 Timoteusbrevet"],
  ["2 Tim", "2 Timoteusbrevet"],
  ["Tit", "Titusbrevet"],
  ["Filem", "Filemonbrevet"],
  ["Hebr", "Hebreerbrevet"],
  ["Jak", "Jakobsbrevet"],
...
var replaceBooks2yv = [
  ...
  ["Romarbrevet", "ROM"],
  ["Första Korinthierbrevet", "1CO"],
  ["Andra Korinthierbrevet", "2CO"],
  ["Galaterbrevet", "GAL"],
  ["Efesierbrevet", "EPH"],
  ["Ef", "EPH"],
  ["Filipperbrevet", "PHP"],
  ["Kolosserbrevet", "COL"],
  ["Första Thessalonikerbrevet", "1TH"],
...
var readingplan = [
  ...
  ["1 Mosebok 9-10", "Filipperbrevet 4", "Psaltaren 3"], ["1 Mosebok 11-12", "Markus 1:1-20"], ["1 Mosebok 13-14", "Markus 1:21-45", "Psaltaren 4"], ["1 Mosebok 15-16", "Markus 2"], ["1 Mosebok 17-18", "Markus 3:1-21", "Psaltaren 5"], ["1 Mosebok 19-20", "Markus 3:22-4:9"], ["1 Mosebok 21-22", "Markus 4:10-41", "Ordspråksboken 1"], ["1 Mosebok 23-24", "Markus 5:1-20"], ["1 Mosebok 25-26", "Markus 5:21-43", "Psaltaren 6"], ["1 Mosebok 27-28", "Markus 6:1-13"], ["1 Mosebok 29-30", "Markus 6:14-44", "Psaltaren 7"], ["1 Mosebok 31-32", "Markus 7:1-13"], ["1 Mosebok 33-34", "Markus 7:14-30", "Psaltaren 8"], ["1 Mosebok 35-36", "Markus 7:31-8:10"], ["1 Mosebok 37-38", "Markus 8:11-30", "Psaltaren 9"], ["1 Mosebok 39-40", "Markus 8:31-9:13"], ["1 Mosebok 41-42", "Markus 9:14-32", "Psaltaren 10"], ["1 Mosebok 43-44", "Markus 9:33-50"], ["1 Mosebok 45-46", "Markus 10:1-31", "Ordspråksboken 2"], ["1 Mosebok 47-48", "Markus 10:32-52"], ["1 Mosebok 49-50", "Markus 11:1-25", "Psaltaren 11"], ["2 Mosebok 1-2", "Markus 11:26-12:12"], ["2 Mosebok 3-4", "Markus 12:13-44", "Psaltaren 12"], ["2 Mosebok 5-6", "Markus 13:1-23"], ["2 Mosebok 7-8", "Markus 13:24-37", "Psaltaren 13"], ["2 Mosebok 9-10", "Markus 14:12-42"], ["2 Mosebok 11-12", "Markus 14:43-65", "Psaltaren 14"], ["2 Mosebok 13-14", "Markus 14:66-15:15"], ["2 Mosebok 15-16", "Markus 15:16-47", "Psaltaren 15"], ["2 Mosebok 17-18", "Markus 16"], ["2 Mosebok 19-20", "Romarbrevet 1:1-15", "Ordspråksboken 3"], ["2 Mosebok 21-22", "Romarbrevet 1:16-32"], ["2 Mosebok 23-24", "Romarbrevet 2", "Psaltaren 16"], ["2 Mosebok 25-26", "Romarbrevet 3:1-20"], ["2 Mosebok 27-28", "Romarbrevet 3:21-31", "Psaltaren 17"], ["2 Mosebok 29-30", "Romarbrevet 4"], ["2 Mosebok 31-32", "Romarbrevet 5", "Psaltaren 18"], ["2 Mosebok 33-34", "Romarbrevet 6"], ["2 Mosebok 35-36", "Romarbrevet 7", "Psaltaren 19"], ["2 Mosebok 37-38", "Romarbrevet 8:1-17"], ["2 Mosebok 39-40", "Romarbrevet 8:18-39", "Psaltaren 20"], ["3 Mosebok 1-3", "Romarbrevet 9:1-29"], ["3 Mosebok 4-5", "Romarbrevet 9:30-10:21", "Ordspråksboken 4-5"], ["3 Mosebok 6-7", "Romarbrevet 11:1-24"], ["3 Mosebok 8-9", "Romarbrevet 11:25-12:8", "Psaltaren 21"], ["3 Mosebok 10-11", "Romarbrevet 12:9-13:7"], ["3 Mosebok 12-13", "Romarbrevet 13:8-14:12", "Psaltaren 22"], ["3 Mosebok 14-15", "Romarbrevet 14:13-15:13"], ["3 Mosebok 16-17", "Romarbrevet 15:14-33", "Psaltaren 23"], ["3 Mosebok 18-19", "Romarbrevet 16"], ["3 Mosebok 20-21", "Johannes 1:1-18", "Psaltaren 24"], ["3 Mosebok 22-23", "Johannes 1:19-34"], ["3 Mosebok 24-25", "Johannes 1:35-51", "Psaltaren 25"], ["3 Mosebok 26-27", "Johannes 2"], ["4 Mosebok 1-2", "Johannes 3:1-21", "Ordspråksboken 5"], ["4 Mosebok 3-4", "Johannes 3:22-36"], ["4 Mosebok 5-6", "Johannes 4:1-30", "Psaltaren 26"], ["4 Mosebok 7-8", "Johannes 4:31-54"], ["4 Mosebok 9-10", "Johannes 5:1-18", "Psaltaren 27"], ["4 Mosebok 11-12", "Johannes 5:19-47"], ["4 Mosebok 13-14", "Johannes 6:1-21", "Psaltaren 28"], ["4 Mosebok 15-16", "Johannes 6:22-59"], ["4 Mosebok 17-18", "Johannes 6:60-71", "Psaltaren 29"], ["4 Mosebok 19-20", "Johannes 7:1-24"], ["4 Mosebok 21-22", "Johannes7:25-53", "Psaltaren 30"], ["4 Mosebok 23-24", "Johannes 8:1-11"], ["4 Mosebok 25-26", "Johannes 8:12-38", "Ordspråksboken 6"], ["4 Mosebok 27-28", "Johannes 8:39-59"], ["4 Mosebok 29-30", "Johannes 9:1-17", "Psaltaren 31"], ["4 Mosebok 31-32", "Johannes 9:18-41"], ["4 Mosebok 33-34", "Johannes 10:1-21", "Psaltaren 32"], ["4 Mosebok 35-36", "Johannes 10:22-42"], ["5 Mosebok 1-2", "Johannes 11:1-16", "Psaltaren 33"], ["5 Mosebok 3-4", "Johannes 11:17-37"], ["5 Mosebok 5-6", "Johannes 11:38-57", "Psaltaren 34"], ["5 Mosebok 7-8", "Johannes 12:1-26"], ["5 Mosebok 9-10", "Johannes 12:27-50", "Psaltaren 35"], ["5 Mosebok 11-12", "Johannes 13:1-20"], ["5 Mosebok 13-14", "Johannes 13:21-38", "Ordspråksboken 7"], ["5 Mosebok 15-16", "Johannes 14:1-14"], ["5 Mosebok 17-18", "Johannes 14:15-31", "Psaltaren 36"], ["5 Mosebok 19-20", "Johannes 15:1-17"], ["5 Mosebok 21-22", "Johannes 15:18-16:15", "Psaltaren 37"], ["5 Mosebok 23-24", "Johannes 16:16-33"], ["5 Mosebok 25", "Johannes 17", "Psaltaren 38"], ["5 Mosebok 26-27", "Johannes 18:1-18"], ["5 Mosebok 28", "Johannes 18:19-40", "Psaltaren 39"], ["5 Mosebok 29-30", "Johannes 19:1-16"], ["5 Mosebok 31-32", "Johannes 19:17-37", "Psaltaren 40"], ["5 Mosebok 33-34", "Johannes 19:38-20:10"], ["Josua 1-2", "Johannes 20:11-31", "Ordspråksboken 8"], ["Josua 3-4", "Johannes 21"], ["Josua 5-6", "Apostlagärningarna 1", "Psaltaren 41"], ["Josua 7-8", "Apostlagärningarna 2:1-13"], ["Josua 9-10", "Apostlagärningarna 2:14-41", "Psaltaren 42"], ["Josua 11-12", "Apostlagärningarna 2:42-3:10"], ["Josua 13-14", "Apostlagärningarna 3:11-26", "Psaltaren 43"], ["Josua 15-16", "Apostlagärningarna 4:1-31"], ["Josua 17-18", "Apostlagärningarna 4:32-5:16", "Psaltaren 44"], ["Josua 19-20", "Apostlagärningarna 5:17-42"], ["Josua 21-22", "Apostlagärningarna 6", "Psaltaren 45"], ["Josua 23-24", "Apostlagärningarna 7:1-32"], ["Domarboken 1-2", "Apostlagärningarna 7:33-60", "Ordspråksboken 9"], ["Domarboken 3-4", "Apostlagärningarna 8:1-25"], ["Domarboken 5-6", "Apostlagärningarna8:26-40", "Psaltaren 46"], ["Domarboken 7-8", "Apostlagärningarna 9:1-20"], ["Domarboken 9-10", "Apostlagärningarna 9:21-43", "Psaltaren 47"], ["Domarboken 11-12", "Apostlagärningarna 10:1-33"], ["Domarboken 13-14", "Apostlagärningarna 10:34-48", "Psaltaren 48"], ["Domarboken 15-17", "Apostlagärningarna 11"], ["Domarboken 18-19", "Apostlagärningarna 12", "Psaltaren 49"], ["Domarboken 20-21", "Apostlagärningarna 13:1-12"], ["Rut 1-2", "Apostlagärningarna 13:13-52", "Psaltaren 50"], ["Rut 3-4", "Apostlagärningarna 14:1-18"], ["1 Samuelsboken 1-2", "Apostlagärningarna 14:19-28", "Ordspråksboken 10"], ["1 Samuelsboken 3-4", "Apostlagärningarna 15:1-21"], ["1 Samuelsboken 5-7", "Apostlagärningarna15:22-41", "Psaltaren 51"], ["1 Samuelsboken 8-9", "Apostlagärningarna 16:1-15"], ["1 Samuelsboken 10-11", "Apostlagärningarna 16:16-40", "Psaltaren 52"], ["1 Samuelsboken 12-13", "Apostlagärningarna 17"], ["1 Samuelsboken 14-15", "Apostlagärningarna 18", "Psaltaren 53"], ["1 Samuelsboken 16-17", "Apostlagärningarna 19:1-20"], ["1 Samuelsboken 18-19", "Apostlagärningarna 19:21-40", "Psaltaren 54"], ["1 Samuelsboken 20-21", "Apostlagärningarna 20:1-16"], ["1 Samuelsboken 22-23", "Apostlagärningarna 20:17-38", "Psaltaren 55"], ["1 Samuelsboken 24-25", "Apostlagärningarna 21:1-26"], ["1 Samuelsboken 26-27", "Apostlagärningarna 21:27-40", "Ordspråksboken 11"], ["1 Samuelsboken 28-29", "Apostlagärningarna 22:1-21"], ["1 Samuelsboken 30-31", "Apostlagärningarna 22:22-23:22", "Psaltaren 56"], ["1 Krönikeboken 1-2", "Apostlagärningarna 23:23-35"], ["1 Krönikeboken 3-4", "Apostlagärningarna 24", "Psaltaren 57"], ["1 Krönikeboken 5-7", "Apostlagärningarna 25"], ["1 Krönikeboken 8-10", "Apostlagärningarna 26", "Psaltaren 58"], ["2 Samuelsboken 1-2", "Apostlagärningarna 27:1-26"], ["2 Samuels
["Ester 1-2", "2 Petrusbrevet 1", "Psaltaren 136"], ["Ester 3-4", "2 Petrusbrevet 2"], ["Ester 5-6", "2 Petrusbrevet 3", "Psaltaren 137"], ["Ester 7-8", "1 Johannesbrevet 1:1-2:14"], ["Ester 9-10", "1 Johannesbrevet 2:15-29", "Psaltaren 138"], ["Esra 7-8", "1 Johannesbrevet 3"], ["Esra 9-10", "1 Johannesbrevet 4", "Psaltaren 139"], ["Nehemja 1-3", "1 Johannesbrevet 5"], ["Nehemja 4-5", "2 Johannesbrevet 1", "Psaltaren 140"], ["Nehemja 6-7", "3 Johannesbrevet 1"], ["Nehemja 8-9", "1 Thessalonikerbrevet 1:1-2:16", "Ordspråksboken 28"], ["Nehemja 10-11", "1 Thessalonikerbrevet 2:17-3:13"], ["Nehemja 12-13", "1 Thessalonikerbrevet 4", "Psaltaren 141"], ["Malaki 1-2", "1 Thessalonikerbrevet 5"], ["Malaki 3-4", "2 Thessalonikerbrevet 1", "Psaltaren 142"], ["Job 1-2", "2 Thessalonikerbrevet 2"], ["Job 3-5", "2 Thessalonikerbrevet 3", "Psaltaren 143"], ["Job 6-7", "Uppenbarelseboken 1"], ["Job 8-9", "Uppenbarelseboken 2", "Psaltaren 144"], ["Job 10-11", "Uppenbarelseboken 3-4"], ["Job 12-13", "Uppenbarelseboken 5", "Psaltaren 145"], ["Job 14-15", "Uppenbarelseboken 6:1-7:8"], ["Job 16-17", "Uppenbarelseboken 7:9-8:13", "Ordspråksboken 29"], ["Job 18-19", "Uppenbarelseboken 9"], ["Job 20-21", "Uppenbarelseboken 10:1-11:14", "Psaltaren 146"], ["Job 22-24", "Uppenbarelseboken 11:15-12:18"], ["Job 25-26", "Uppenbarelseboken 13", "Psaltaren 147"], ["Job 27-28", "Uppenbarelseboken 14-15"], ["Job 29-31", "Uppenbarelseboken 16", "Psaltaren 148"], ["Job 32-33", "Uppenbarelseboken 17"], ["Job 34-35", "Uppenbarelseboken 18", "Psaltaren 149"], ["Job 36-37", "Uppenbarelseboken 19"], ["Job 38-39", "Uppenbarelseboken 20:1-21:8", "Ordspråksboken 30"], ["Job 40-41", "Uppenbarelseboken 21:9-27", "Ordspråksboken 31"], ["Job 42", "Uppenbarelseboken 22", "Psaltaren 150"]];
...
\n`;
  ...
  var readpl = readingplan.map(nested => nested.map(e => mkabbr(e) ));
...
showMonthYear = (arr, mese, anno) => {
  ...
  // Månadsrubrik - Stor, fet och med en lila linje under
  lk += `<h3 class="text-2xl font-bold text-slate-800 border-b-2 border-indigo-500 pb-2 mb-6 mt-10 first:mt-0">${months[this.mese]} ${this.anno}</h3>`;
  
  let currentWeek = null; // För att undvika att skriva ut samma veckonummer flera gånger

  for (let i of arr) {
    if (new Date(i.time).getMonth() === this.mese && new Date(i.time).getFullYear() === this.anno) {
      
      // SMART UX: Rita bara ut veckonumret om vi har bytt vecka
      if (currentWeek !== i.Week) {
        lk += `<div class="mt-10 mb-4 flex items-center">
                 <span class="bg-slate-100 text-slate-500 text-xs font-bold uppercase tracking-wider py-1 px-3 rounded-full">Vecka ${i.Week}</span>
      ...
      // KORTET FÖR DAGEN
      lk += `<div class="mb-5 p-5 bg-white border border-slate-200 rounded-xl shadow-sm hover:shadow-md transition-shadow relative overflow-hidden break-inside-avoid">`;
      
      // Sidhuvud i kortet (Datum, Titel, Färg, Årgång)
      lk += `<div class="flex flex-col md:flex-row md:items-baseline md:justify-between mb-3 pb-3 border-b border-slate-100 gap-2">`;
      
      // Vänster: Datum och Titel
      let dayName = days[new Date(i.time).getDay()];
      lk += `<div>
               <span class="text-lg font-bold text-indigo-700 mr-2">${new Date(i.time).getDate()} ${dayName}</span>
               <span class="text-lg font-semibold text-slate-800">${i.Title}</span>
             </div>`;
      
      // Höger: Färg och Årgång som snygga etiketter (badges)
      let argangText = i.Argang ? (i.Argang === 1 ? 'I' : (i.Argang === 2 ? 'II' : 'III')) : '';
      lk += `<div class="flex items-center gap-2">`;
      if (i.Color) {
         lk += `<span class="px-2.5 py-0.5 rounded-full border border-slate-200 bg-slate-50 text-slate-600 text-xs font-medium">${i.Color}</span>`;
      }
      if (argangText) {
         lk += `<span class="px-2.5 py-0.5 rounded-full bg-indigo-50 text-indigo-700 text-xs font-bold" title="Årgång">Årgång ${argangText}</span>`;
      }
      lk += `</div></div>`; // Stäng flex-huvudet

      // Temat (kursivt)
      lk += `<p class="text-sm font-medium text-slate-500 italic mb-4">"${i.Theme}"</p>`;

      // TEXTERNA / LÄSNINGARNA (Strukturerade i ett rutnät/grid)
      lk += `<div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2 text-slate-700 text-base">`;
      
      // Huvudtexter
      if (!isBlank(i.Psalms)) lk += `<div class="flex items-start"><span class="w-12 flex-shrink-0 font-bold text-slate-400 text-xs uppercase tracking-widest mt-1.5">Ps</span> <span class="text-indigo-600 hover:text-indigo-800">${mkyv(i.Psalms)}</span></div>`;
      if (!isBlank(i.OldT))   lk += `<div class="flex items-start"><span class="w-12 flex-shrink-0 font-bold text-slate-400 text-xs uppercase tracking-widest mt-1.5">GT</span> <span class="text-indigo-600 hover:text-indigo-800">${mkyv(i.OldT)}</span></div>`;
      if (!isBlank(i.Letters))lk += `<div class="flex items-start"><span class="w-12 flex-shrink-0 font-bold text-slate-400 text-xs uppercase tracking-widest mt-1.5">Ep</span> <span class="text-indigo-600 hover:text-indigo-800">${mkyv(i.Letters)}</span></div>`;
      if (!isBlank(i.Gospel)) lk += `<div class="flex items-start"><span class="w-12 flex-shrink-0 font-bold text-slate-400 text-xs uppercase tracking-widest mt-1.5">Ev</span> <span class="font-semibold text-slate-900">${mkyv(i.Gospel)}</span></div>`; 
      
      // Extraläsningar för årgång 2 och 3 (Högmässa och Aftonsång)
      if ((i.Argang == 2 || i.Argang == 3) && i.HHM !== null) {
         lk += `<div class="col-span-1 md:col-span-2 border-t border-slate-100 mt-2 pt-3 grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2">`;
         if (!isBlank(i.HHM)) lk += `<div class="flex items-start"><span class="w-12 flex-shrink-0 font-bold text-slate-400 text-xs uppercase tracking-widest mt-1.5">Högm.</span> <span class="text-slate-600">${mkyv(i.HHM)}</span></div>`;
         if (!isBlank(i.AFT)) lk += `<div class="flex items-start"><span class="w-12 flex-shrink-0 font-bold text-slate-400 text-xs uppercase tracking-widest mt-1.5">Afton</span> <span class="text-slate-600">${mkyv(i.AFT)}</span></div>`;
         lk += `</div>`;
      }
